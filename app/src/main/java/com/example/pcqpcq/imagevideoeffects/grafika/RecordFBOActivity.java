...
package com.example.pcqpcq.imagevideoeffects.grafika;
...
import com.example.pcqpcq.imagevideoeffects.R;
...
public class RecordFBOActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static final String TAG = RecordFBOActivity.class.getName();
